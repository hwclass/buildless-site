    ...
    (l.__k = b(l.__k, function(u) {
      if (null != u) {
        ...
        if (
          ...
          if ((null == w && (w = y), null != u.__d))
            (y = u.__d), (u.__d = null);
          else if (o == p || y != c || null == y.parentNode) {
            n: if (null == c || c.parentNode !== n) n.appendChild(y);
            else {
    ...
    n: if ("function" == typeof P) {
      ...
      (h.context = C),
        ...
        v ||
          ...
          (w = h.getSnapshotBeforeUpdate(p, m)),
        _(l, u, i, t, o, f, r, e, c),
        (h.base = u.__e),
        h.__h.length && r.push(h),
        g && (h.__E = h.__ = null),
...
function j(n, l, u, i, t, o, f, c) {
  ...
  if (null === l.type)
    null != o && (o[o.indexOf(n)] = null), y !== d && (n.data = d);
  else if (l !== u) {
    if (
      (null != o && (o = e.slice.call(n.childNodes)),
      (h = (y = u.props || r).dangerouslySetInnerHTML),
...
function E(l, u, i) {
  ...
  n.__ && n.__(l, u),
    ...
    T(
      ...
      i && !t ? [i] : f ? null : e.slice.call(u.childNodes),
      c,
      i || r,
      t
    ),
